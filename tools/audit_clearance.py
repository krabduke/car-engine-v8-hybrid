...
PAIRS = [
    ...
    ("turbine_housing_1", "camcover_l", 5.0,
     "the turbos live in the vee, not in a head"),
    ("turbine_housing_1", "camcover_r", 5.0,
     "the turbos live in the vee, not in a head"),
    ("turbine_housing_2", "camcover_l", 5.0,
     "the turbos live in the vee, not in a head"),
    ("turbine_housing_2", "camcover_r", 5.0,
     "the turbos live in the vee, not in a head"),
    ("compressor_housing_1", "camcover_l", 5.0,
     "the cold side clears the heads too"),
    ("compressor_housing_2", "camcover_r", 5.0,
     "the cold side clears the heads too"),
