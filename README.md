...
**33 assemblies · 2.0 L · 1,254 hp combined · 16,000 rpm · 146 kg**
...
make verify     # 21 architecture, kinematic and output checks
...
`make verify` runs 21 checks. Some are dimensional, measured out of
